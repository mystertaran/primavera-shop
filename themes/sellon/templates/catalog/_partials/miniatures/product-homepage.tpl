...
{/if}
  ...
  <article class="product-miniature js-product-miniature {$belvg_column_value_hp}" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
