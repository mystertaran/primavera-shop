...
class CustomHtmlClass extends ObjectModel
{
	...
	public static $definition = array(
		'table' => 'belvgcustomhtml',
		'primary' => 'id_belvgcustomhtml',
		'multilang' => true,
		'multilang_shop' => true,
		'fields' => array(
	...
	public	function __construct($id_tab = null, $id_lang = null, $id_shop = null, Context $context = null)
	{
		...
		Shop::addTableAssociation('belvgcustomhtml', array('type' => 'shop'));
		Shop::addTableAssociation('belvgcustomhtml_lang', array('type' => 'fk_shop'));
		if ($this->id)
		{
	...
	public function getFieldShop($field)
	{
		...
		$sql = 'SELECT bs.'.$field.' FROM '._DB_PREFIX_.'belvgcustomhtml b
		LEFT JOIN '._DB_PREFIX_.'belvgcustomhtml_shop bs ON (b.id_belvgcustomhtml = bs.id_belvgcustomhtml)
		WHERE b.id_belvgcustomhtml = '.$this->id.' AND bs.id_shop = '.$id_shop.'';
