...
* @author PrestaShop SA <contact@prestashop.com>
  ...
  *}
        ...
        <div class="contact-info-wrap col-md-5 col-sm-12">
          ...
          <div class="payments-container links wrapper">
            ...
            <div class="payments-info__content">
              <div class="payments-info__item_p24now">
              ...
              <div class="payments-info__item">
                <img src="https://primavera.sklep.pl/themes/sellon/assets/img/payments/przelewy24.png"
                  alt="Przelewy24" />
              </div>
            </div>
          </div>
      ...
      <div class="row copyright">
        <div class="col-md-12">
          ...
          <a class="_blank" href="https://sdconcept.pl" target="_blank">
            {l s='%copyright% %year% - Sklep Primavera. Wykonanie: %prestashop%' sprintf=['%prestashop%' => 'SDConcept',
            '%year%' => 'Y'|date, '%copyright%' => '©'] d='Shop.Theme'}
          </a>
          {/block}
        </div>
      </div>
  ...
  <a id="scroll-top" href="#header">
    <svg version="1.1" id="Capa_1" width="15px" height="15px" xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="451.847px" height="451.846px"
      viewBox="0 0 451.847 451.846" style="enable-background:new 0 0 451.847 451.846;" xml:space="preserve">
      <g>
