...
{assign var = belvg_column_value_cp value=''}
{if Module::isEnabled('columnsconfigurator')}
	{assign var = belvg_column_value_cp_postfix value = Configuration::get('COLUMN_VAL_CP')}
	{assign var = belvg_column_value_cp value = 'col-'|cat:$belvg_column_value_cp_postfix}
{/if}

  <article class="product-miniature js-product-miniature {$belvg_column_value_cp}" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
