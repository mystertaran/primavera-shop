...
<div id="search_widget" class="search-widget" data-search-controller-url="{$search_controller_url}">
	<div class="search-toggle"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="23px" height="23px" viewBox="0 0 475.084 475.084" style="enable-background:new 0 0 475.084 475.084;" xml:space="preserve">
<g>
	...
	<form method="get" action="{$search_controller_url}">
		...
		<input class="search-input" type="text" name="s" value="{$search_string}" placeholder="{l s='' d='Shop.Theme.Catalog'}">
		<button type="submit">
