...
<svg version="1.1" id="Capa_1" width="45px" height="45px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 345.834 345.834" style="enable-background:new 0 0 345.834 345.834;" xml:space="preserve">
<g>
	...
	<path d="M62.5,226.51h-55c-4.143,0-7.5,3.357-7.5,7.5s3.357,7.5,7.5,7.5h55c4.143,0,7.5-3.357,7.5-7.5S66.643,226.51,62.5,226.51z"></path>
	    ...
	    {l s='Newsletter' d='Shop.Theme'}</h2>
	    <p>{l s='Sign up for our newsletter and get hot offers and special deals!' d='Shop.Theme.Actions'}</p>
    <div class="block_newsletter-from col-md-6 col-sm-12">
